...
//             suggestionUrl = `http://localhost:3500/api/v1/movie/suggestion/${query}`;
//         } else {
//             suggestionUrl = `http://localhost:3500/api/v1/movie/suggestion/${filter}/${query}`;
//         }
...
//                 setSelectedSuggestion(inputSearch);
//             }
//             console.log(selectedSuggestion);
//             console.log(filter);
    
//             // Clear suggestions after search submit
//             setSuggestions([]);
    
//             // Adjust the search URL based on the filter
//             let searchUrl;
//             if (filter === 'all' || filter === 'title') {
//                 searchUrl = `http://localhost:3500/api/v1/movie/${selectedSuggestion}`;
//                 console.log(selectedSuggestion)
//             } else {
//                 searchUrl = `http://localhost:3500/api/v1/movie/search?${filter}=${selectedSuggestion}`;
//             }
